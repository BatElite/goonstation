...
/datum/emote/birdwell/bio/enact(mob/user, voluntary = 0, param)
	if ((user.client && user.client.holder))
		playsound(user.loc, 'sound/vox/birdwell.ogg', 50, 1, channel=VOLUME_CHANNEL_EMOTE)
...
/datum/emote/poo/enact(mob/user, voluntary = 0, param)
	return list("<B>[user]</B> grunts for a moment. [prob(1) ? "Something" : "Nothing"] happens.", "<I>grunts</I>", MESSAGE_AUDIBLE)
