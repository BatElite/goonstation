...
/datum/syndicate_buylist/traitor/syndie_surgery
	...
	cost = 3
	desc = "Drawing too much suspicion constantly re-poisoning your surgery tools? This set is machined with an internal reservoir to last several successive surgeries! Despite the box' claims, the contents are 100% guaranteed not sterile."
	job = list("Medical Doctor", "Medical Director", "Geneticist", "Roboticist")
	blockedmode = list(/datum/game_mode/spy, /datum/game_mode/revolution)
