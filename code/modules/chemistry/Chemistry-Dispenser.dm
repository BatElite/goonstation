/obj/machinery/chem_dispenser
	...
	var/image/glass_overlay = null //Overlay for inserted glass

	New()
		..()
		update_account()
		glass_overlay = image('icons/obj/chemical.dmi', null)
